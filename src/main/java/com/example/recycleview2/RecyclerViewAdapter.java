...
public class RecyclerViewAdapter extends RecyclerView.Adapter <RecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            Para1=view.findViewById(R.id.Para1);
            Para2=view.findViewById(R.id.Para2);
            Para3=view.findViewById(R.id.Para3);
            Para4=view.findViewById(R.id.Para4);
            Para5=view.findViewById(R.id.Para5);
            Para6=view.findViewById(R.id.Para6);
            Para7=view.findViewById(R.id.Para7);
            Para8=view.findViewById(R.id.Para8);
            Para9=view.findViewById(R.id.Para9);
            Para10=view.findViewById(R.id.Para10);
        }
    }
}